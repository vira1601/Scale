...
describe('User Creates New Role', () => {
    ...
    it('User Visits Roles General Page', () => {
    ...
    //  it('User Clicks Drip Talents Tab', () => {
    //     cy.get('#tab-tab-talent-drip')
    //     cy.should('be.visible')
    //     cy.wait('#tab-tab-talent-drip')
    // })
    
    // it('User Input Talent Name', () => {
    //     cy.get(':nth-child(1) > .eds-input-group > .ant-input')
    //     .type('test')
    // })
    // it('User Clicks Search button', () => {
